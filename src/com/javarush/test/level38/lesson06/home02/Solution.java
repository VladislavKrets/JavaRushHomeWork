...
public class Solution {
    ...
    public Solution() throws SolutionException {
        try {
            ...
            throw new SolutionException(e instanceof WrongDataException ? "WrongDataException: " + ((WrongDataException) e).getMessage() : "ConnectionException: " + ((ConnectionException) e).getMessage());
        }
