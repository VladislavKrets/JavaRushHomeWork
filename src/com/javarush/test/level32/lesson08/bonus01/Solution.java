...
public class Solution {
    ...
    public <T extends Item> T getProxy(Class firstClass, Class... classes) {
        Class[] interfaces = new Class[classes.length + 1];
        System.arraycopy(classes, 0, interfaces, 0, classes.length);
        interfaces[interfaces.length - 1] = firstClass;
        return (T) Proxy.newProxyInstance(firstClass.getClassLoader(), interfaces, new ItemInvocationHandler());
    }
}
