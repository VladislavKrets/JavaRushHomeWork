...
public class Solution {
    ...
    public static Object convertOneToAnother(Object one, Class resultClassObject) throws IOException {
        ...
        objectNode.put(((JsonTypeInfo)resultClassObject.getAnnotation(JsonTypeInfo.class)).property(), resultClassObject.getSimpleName().toLowerCase());

        StringReader reader = new StringReader(objectNode.toString());
