    ...
    public static void sort(List<Stock> list) {
        Collections.sort(list, new Comparator<Stock>() {
            public int compare(Stock stock1, Stock stock2) {
                ...
                else if ((((Date)stock1.get("date")).getTime() != ((Date)(stock2.get("date"))).getTime())) {
                    return (((Date)stock1.get("date")).compareTo((Date)(stock2.get("date"))));
                }
                else
                return ((Double)((Double)(stock2.get("last")) - ((Double)stock2.get("open")))).compareTo((Double) ((Double)stock1.get("last") - (Double) stock1.get("open")));
            }
        });
    }
